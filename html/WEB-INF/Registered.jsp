			...
			<ul class="nav navbar-nav" id="navbarontop">
				...
				<li class="dropdown">
						...
						<ul class="dropdown-menu dropdowncostume">
							...
							<li><a href="#">EXCHANGES MANAGEMENT</a></li>
...
<!--_______________________________________ Carousel__________________________________ -->
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      ...
      <img src="image/slide1.jpg" alt="registered">
	  
      <div class="carousel-caption">
      <h1><b>REGISTERED VEHICLES</b></h1>
      </div>
    </div>
	<div class="item">
	
      <img src="image/slide2.jpg" alt="unregistered">
	  
      <div class="carousel-caption">
        <h1> <b>UNREGISTERED VEHICLES</b></h1>
      </div>
	  </div>
	  <div class="item">
	  
      <img src="image/slide3.jpg" alt="parts">
	  
      <div class="carousel-caption">
        <h1> <b>BODY PARTS</b></h1>
      </div>
	  </div>
  </div>
