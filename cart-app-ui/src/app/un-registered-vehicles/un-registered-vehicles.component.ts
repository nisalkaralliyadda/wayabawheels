...
@Component({
  ...
  templateUrl: './un-registered-vehicles.component.html',
  styleUrls: ['./un-registered-vehicles.component.css']
})
export class UnRegisteredVehiclesComponent implements OnInit {
